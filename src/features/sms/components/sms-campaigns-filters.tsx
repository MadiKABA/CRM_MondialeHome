...
import { CAMPAIGN_STATUSES, CAMPAIGN_STATUS_LABELS } from "@/features/campaigns/types";

export function SmsCampaignsFilters() {
    ...
    <div className="flex flex-col gap-3 sm:flex-row">
      <div className="relative flex-1">
        ...
        <Input
          ...
          placeholder="Rechercher une campagne SMS..."
